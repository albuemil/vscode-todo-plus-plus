...
function toggleInfo() {
  ...
  return callTodosMethod('toggleInfo');
...
function toggleUrgent() {
  ...
  return callTodosMethod('toggleUrgent');
...
export { open, openEmbedded, toggleBox, toggleDone, toggleCancelled, toggleStart, toggleInfo, toggleUnknown, toggleUrgent, toggleTimer, archive, viewOpenFile, viewRevealTodo, viewFilesOpen, viewFilesCollapse, viewFilesExpand, viewEmbeddedCollapse, viewEmbeddedExpand, viewEmbeddedFilter, embeddedFilter, viewEmbeddedClearFilter, embeddedClearFilter, viewEmbeddedToggleAllFiles, viewEmbeddedShowAllFiles, viewEmbeddedShowActiveFile };
export { viewFocusOpen, viewFocusExpand, viewFocusCollapse };
export { toggleBox as editorToggleBox, toggleDone as editorToggleDone, toggleCancelled as editorToggleCancelled, toggleStart as editorToggleStart, toggleInfo as editorToggleInfo, toggleUnknown as editorToggleUnknown, toggleUrgent as editorToggleUrgent, archive as editorArchive };
